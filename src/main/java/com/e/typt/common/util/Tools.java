...
import com.e.typt.common.exception.RequestException;
...
*/
 /*   public static synchronized void executeLogin(){
    ...
    public static <T> JSONObject getDataField(T data) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
        ...
        for(Field field : fields){
            ...
            String string = propertyUtilsBean.getNestedProperty(data, name).toString();
            o.put(name, string);
        }
        return o;
    }
